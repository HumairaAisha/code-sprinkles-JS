    ...
    <div className="h-screen bg-[#F3F4F6] p-4">
      <div>
        <div className="bg-[#0f1a32] rounded-lg text-white p-1.5 m-2">
          ...
          <p className="text-sm my-1 px-2">Log learnning progress, track hours spent, and see your growth over time, with ideas that shape your journey. <br />
          ...
          <div className="flex justify-end px-4 items-center -my-2 mb-1">
             ...
             {openModal && (
              <Modal onClose={closeForm}>
                <MyForm onAddRecord={handleNewRecords}/> 
              </Modal>
             )}
          </div>
        ...
        <div className="overflow-x-auto mt-6 p-2">
         {records.length > 0 ? (
          <table className="min-w-full border border-[#0F172A] border-collapse text-[#0F172A] rounded-lg">
            <thead className="bg-[#E2E8F0]">
              <tr className="border-b border-[#0F172A]">
                <th className="border border-[#0F172A] p-1">Date</th>
                <th className="border border-[#0F172A] p-1">Hours</th>
                <th className="border border-[#0F172A] p-1">What I Learned</th>
                <th className="border border-[#0F172A] p-1">Category</th>
                <th className="border border-[#0F172A] p-1">Description</th>
                <th className="border border-[#0F172A] p-1">Feature Built</th>
